    ...
    <div>
      ...
      <div className="relative rounded-2xl overflow-hidden"
        ...
        <div className="relative z-10 p-4">
          ...
          {/* CTA perpanjang — Maneki Neko + tombol WA */}
          {waHref && (
            <div className="rounded-2xl overflow-hidden"
              ...
              <div className="flex items-end justify-between px-4 pt-3 pb-0">
                <div className="flex-1 pb-2">
                  <p className="text-[13px] font-extrabold leading-tight" style={{ color: '#1A0A00' }}>
                    Yuk lanjut belajar lagi!
                  </p>
                  <p className="text-[10px] mt-0.5" style={{ color: 'rgba(26,10,0,0.6)' }}>
              ...
              <a href={waHref} target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-3 font-extrabold text-[13px] active:scale-95 transition-transform"
                style={{ background: 'rgba(0,0,0,0.15)', color: '#1A0A00' }}>
