...
export default function TutorDetailPage() {
  ...
  const [tab,      setTab]      = useState<'profil'|'kelas'|'jadwal'|'honor'>('profil')
    ...
    <div className="max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          {!tutor.education_level && !achievements.length && !tutor.bio && (
            <div className="bg-white rounded-2xl border border-[#E5E3FF] p-8 text-center">
              ...
              <Link href={`/admin/tutor/${tutorId}/edit`} className="text-sm text-[#5C4FE5] font-semibold hover:underline mt-2 block">
                + Lengkapi profil
              </Link>
            </div>
          )}
      ...
      {tab === 'honor' && (
        <div className="space-y-4">
          ...
          <div className="px-4 py-3 bg-[#FEF3E2] border border-[#FCD34D] rounded-xl text-xs text-[#92400E]">
            ⚠️ Sesi perkenalan (sesi 0/8) tidak dihitung dalam honor tutor.
          </div>
