...
// Logo teks: Edu (ungu) + Kazia (kuning)
function LogoText() {
  return (
    <Link href="/tutor/dashboard" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0px' }}>
      <span style={{ fontSize: '20px', fontWeight: 900, color: '#5C4FE5', fontFamily: 'Sora, sans-serif', letterSpacing: '-0.5px' }}>Edu</span>
      <span style={{ fontSize: '20px', fontWeight: 900, color: '#E6B800', fontFamily: 'Sora, sans-serif', letterSpacing: '-0.5px' }}>kazia</span>
    </Link>
  )
}
