                ...
                <div className="flex justify-center mb-2 -mt-2">
                  <svg width="110" height="155" viewBox="0 0 180 260" xmlns="http://www.w3.org/2000/svg" style={{ overflow: 'visible' }}>
                    <style>{`
                      ...
                      @keyframes neko-sparkle { 0%,100%{opacity:0;transform:scale(0.5)} 50%{opacity:1;transform:scale(1)} }
                      .nk-body{animation:neko-float 3s ease-in-out infinite}
                      .nk-arm{transform-origin:72px 108px;animation:neko-wave 1.2s ease-in-out infinite}
                      .nk-eyeL{transform-origin:78px 118px;animation:neko-blink 4s ease-in-out infinite}
                      .nk-eyeR{transform-origin:102px 118px;animation:neko-blink 4s ease-in-out infinite}
                    ...
                    <g className="nk-body">
                      ...
                      <g className="nk-eyeL"><ellipse cx="78" cy="110" rx="7" ry="7" fill="#1A1A2E"/><ellipse cx="80" cy="108" rx="2.5" ry="2.5" fill="white"/></g>
                      <g className="nk-eyeR"><ellipse cx="102" cy="110" rx="7" ry="7" fill="#1A1A2E"/><ellipse cx="104" cy="108" rx="2.5" ry="2.5" fill="white"/></g>
